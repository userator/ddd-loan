...
class ClientCreate extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $client = $this->useCase->createClient([
            ...
            'city' => $helper->ask($input, $output, new Question('Введите город: ', 'New York')),
            'state' => $helper->ask($input, $output, new Question('Введите код штата: ', 'NY')),
            'zip' => $helper->ask($input, $output, new Question('Введите ZIP: ', '10001')),
